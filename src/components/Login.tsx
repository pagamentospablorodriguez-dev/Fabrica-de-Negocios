...
export default function Login({ onSwitchToCadastro }: LoginProps) {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      setErro(error instanceof Error ? error.message : 'Erro ao fazer login com Google');
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="max-w-md w-full">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400">
              Entre na sua conta para gerar ideias de negócios
            </p>
          </div>

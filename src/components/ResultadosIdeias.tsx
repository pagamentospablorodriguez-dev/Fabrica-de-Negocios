                ...
                {ideiaExpandida === index && (
                  <div className="border-t luxury-border p-6 bg-luxury-black">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                      <SecaoIdeia icon={<Target className="w-5 h-5 text-luxury-gold" />} titulo="Análise de Viabilidade" conteudo={ideia.analiseViabilidade} />
                      <SecaoIdeia icon={<TrendingUp className="w-5 h-5 text-luxury-gold" />} titulo="Como Viralizar" conteudo={ideia.comoViralizar} />
                      <SecaoIdeia icon={<Users className="w-5 h-5 text-luxury-gold" />} titulo="Público-Alvo" conteudo={ideia.publicoAlvo} />
                      <SecaoIdeia icon={<Megaphone className="w-5 h-5 text-luxury-gold" />} titulo="Estratégia de Marketing" conteudo={ideia.estrategiaMarketing} />
                      <SecaoIdeia icon={<Calendar className="w-5 h-5 text-luxury-gold" />} titulo="Roadmap de Lançamento" conteudo={ideia.roadmapLancamento} />
                      <SecaoIdeia icon={<MessageSquare className="w-5 h-5 text-luxury-gold" />} titulo="Scripts de Anúncios" conteudo={ideia.scriptAnuncios} />
                      <SecaoIdeia icon={<Video className="w-5 h-5 text-luxury-gold" />} titulo="Conteúdo Orgânico" conteudo={ideia.scriptConteudoOrganico} />
                      <SecaoIdeia icon={<DollarSign className="w-5 h-5 text-luxury-gold" />} titulo="Formas de Monetização" conteudo={ideia.formasMonetizacao} />
                      <SecaoIdeia icon={<CheckCircle className="w-5 h-5 text-luxury-gold" />} titulo="Primeiros Passos" conteudo={ideia.primeirosPassos} />
                      <SecaoIdeia icon={<TrendingUp className="w-5 h-5 text-luxury-gold" />} titulo="Metas Financeiras" conteudo={ideia.metasFinanceiras} />
                    </div>
